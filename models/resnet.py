...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, input_channel=3, num_classes=1000, zero_init_residual=False,
    ...
    def _forward_impl(self, x, need_feat):
    ...
    def forward(self, x, need_feat=False):
        return self._forward_impl(x, need_feat)
