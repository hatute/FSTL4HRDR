...
def parse_option():
    ...
    parser.add_argument('--lr_decay_epochs', type=str,
                        default='10,20', help='where to decay lr, can be a list')
    ...
    opt.model_name = 'Teacher_{}_epochs{}_alpha{}_T{}_{}'.format(
        opt.model, opt.epochs, opt.alpha, opt.temperature, opt.info)
